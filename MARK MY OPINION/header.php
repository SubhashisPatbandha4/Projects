      ...
      <a href="timeline-question.php">  <div class="nav_brand">
        ...
        <div style="margin-left:-0px;" class="dropdown nav_extra">
            ...
            <a class="dropdown-item" href="logout.php">Logout</a>
                <a class="dropdown-item" href="profile-question.php?id=<?php echo $_SESSION['myopinion_userid'];?>">Profile</a>
        ...
        <div class="nav_search">
            <form class="form-inline my-2 my-lg-0" method="get" action="timeline-question.php">
                <input name="find-question" class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
